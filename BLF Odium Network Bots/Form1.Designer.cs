...
namespace BLF_Odium_Network_Bots
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            cmbTargetPlayer = new ComboBox();
            lblDamageAmount = new Label();
            nudDamage = new NumericUpDown();
            chkHeadshot = new CheckBox();
            btnDamagePlayer = new Button();
            btnShowHitmarker = new Button();
            btnMeleeAttack = new Button();
            btnReload = new Button();
            btnThrowGrenade = new Button();
            grpKillstreaks = new GroupBox();
            lblKillstreak = new Label();
            cmbKillstreak = new ComboBox();
            chkSameTeam = new CheckBox();
            btnActivateKillstreak = new Button();
            btnNuke = new Button();
            ...
            btnSetTimeScale = new Button();
            chkMatchOver = new CheckBox();
            btnMatchOver = new Button();
            nudColorR = new NumericUpDown();
            nudColorG = new NumericUpDown();
            nudColorB = new NumericUpDown();
            grpChat = new GroupBox();
            lblChatMsg = new Label();
            txtChatMessage = new TextBox();
            lblChatColor = new Label();
            ...
            grpKillstreaks.SuspendLayout();
            grpGameControl.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)nudTimeScale).BeginInit();
            ((System.ComponentModel.ISupportInitialize)nudColorR).BeginInit();
            ((System.ComponentModel.ISupportInitialize)nudColorG).BeginInit();
            ((System.ComponentModel.ISupportInitialize)nudColorB).BeginInit();
            ...
            // grpCombat
            // 
            grpCombat.Controls.Add(lblTargetPlayer);
            grpCombat.Controls.Add(cmbTargetPlayer);
            grpCombat.Controls.Add(lblDamageAmount);
            grpCombat.Controls.Add(nudDamage);
            grpCombat.Controls.Add(chkHeadshot);
            grpCombat.Controls.Add(btnDamagePlayer);
            grpCombat.Controls.Add(btnShowHitmarker);
            grpCombat.Controls.Add(btnMeleeAttack);
            grpCombat.Controls.Add(btnReload);
            grpCombat.Controls.Add(btnThrowGrenade);
            grpCombat.ForeColor = Color.FromArgb(180, 180, 180);
            grpCombat.Location = new Point(1299, 546);
            grpCombat.Name = "grpCombat";
            grpCombat.Size = new Size(260, 235);
            grpCombat.TabIndex = 12;
            grpCombat.TabStop = false;
            grpCombat.Text = "Combat Actions";
            // 
            // lblTargetPlayer
            // 
            lblTargetPlayer.AutoSize = true;
            lblTargetPlayer.Location = new Point(15, 25);
            lblTargetPlayer.Name = "lblTargetPlayer";
            lblTargetPlayer.Size = new Size(78, 15);
            lblTargetPlayer.TabIndex = 0;
            lblTargetPlayer.Text = "Target Player:";
            // 
            // cmbTargetPlayer
            // 
            cmbTargetPlayer.BackColor = Color.FromArgb(40, 40, 43);
            cmbTargetPlayer.FlatStyle = FlatStyle.Flat;
            cmbTargetPlayer.ForeColor = Color.FromArgb(220, 220, 220);
            cmbTargetPlayer.Location = new Point(15, 43);
            cmbTargetPlayer.Name = "cmbTargetPlayer";
            cmbTargetPlayer.Size = new Size(230, 23);
            cmbTargetPlayer.TabIndex = 1;
            // 
            // lblDamageAmount
            // 
            lblDamageAmount.AutoSize = true;
            lblDamageAmount.Location = new Point(15, 75);
            lblDamageAmount.Name = "lblDamageAmount";
            lblDamageAmount.Size = new Size(54, 15);
            lblDamageAmount.TabIndex = 2;
            lblDamageAmount.Text = "Damage:";
            // 
            // nudDamage
            // 
            nudDamage.BackColor = Color.FromArgb(40, 40, 43);
            nudDamage.BorderStyle = BorderStyle.FixedSingle;
            nudDamage.ForeColor = Color.FromArgb(220, 220, 220);
            nudDamage.Location = new Point(15, 93);
            nudDamage.Minimum = new decimal(new int[] { 1, 0, 0, 0 });
            nudDamage.Name = "nudDamage";
            nudDamage.Size = new Size(100, 23);
            nudDamage.TabIndex = 3;
            nudDamage.Value = new decimal(new int[] { 50, 0, 0, 0 });
            // 
            // chkHeadshot
            // 
            chkHeadshot.AutoSize = true;
            chkHeadshot.Location = new Point(130, 95);
            chkHeadshot.Name = "chkHeadshot";
            chkHeadshot.Size = new Size(77, 19);
            chkHeadshot.TabIndex = 4;
            chkHeadshot.Text = "Headshot";
            // 
            // btnDamagePlayer
            // 
            btnDamagePlayer.BackColor = Color.FromArgb(255, 68, 68);
            btnDamagePlayer.FlatStyle = FlatStyle.Flat;
            btnDamagePlayer.ForeColor = Color.White;
            btnDamagePlayer.Location = new Point(15, 125);
            btnDamagePlayer.Name = "btnDamagePlayer";
            btnDamagePlayer.Size = new Size(230, 28);
            btnDamagePlayer.TabIndex = 5;
            btnDamagePlayer.Text = "Damage Target";
            btnDamagePlayer.UseVisualStyleBackColor = false;
            btnDamagePlayer.Click += btnDamagePlayer_Click;
            // 
            // btnShowHitmarker
            // 
            btnShowHitmarker.BackColor = Color.FromArgb(60, 60, 63);
            btnShowHitmarker.FlatStyle = FlatStyle.Flat;
            btnShowHitmarker.ForeColor = Color.FromArgb(220, 220, 220);
            btnShowHitmarker.Location = new Point(15, 158);
            btnShowHitmarker.Name = "btnShowHitmarker";
            btnShowHitmarker.Size = new Size(109, 28);
            btnShowHitmarker.TabIndex = 6;
            btnShowHitmarker.Text = "Hitmarker";
            btnShowHitmarker.UseVisualStyleBackColor = false;
            btnShowHitmarker.Click += btnShowHitmarker_Click;
            // 
            // btnMeleeAttack
            // 
            btnMeleeAttack.BackColor = Color.FromArgb(60, 60, 63);
            btnMeleeAttack.FlatStyle = FlatStyle.Flat;
            btnMeleeAttack.ForeColor = Color.FromArgb(220, 220, 220);
            btnMeleeAttack.Location = new Point(130, 158);
            btnMeleeAttack.Name = "btnMeleeAttack";
            btnMeleeAttack.Size = new Size(115, 28);
            btnMeleeAttack.TabIndex = 7;
            btnMeleeAttack.Text = "Melee";
            btnMeleeAttack.UseVisualStyleBackColor = false;
            btnMeleeAttack.Click += btnMeleeAttack_Click;
            // 
            // btnReload
            // 
            btnReload.BackColor = Color.FromArgb(60, 60, 63);
            btnReload.FlatStyle = FlatStyle.Flat;
            btnReload.ForeColor = Color.FromArgb(220, 220, 220);
            btnReload.Location = new Point(15, 192);
            btnReload.Name = "btnReload";
            btnReload.Size = new Size(109, 28);
            ...
            // btnThrowGrenade
            // 
            btnThrowGrenade.BackColor = Color.FromArgb(60, 60, 63);
            btnThrowGrenade.FlatStyle = FlatStyle.Flat;
            btnThrowGrenade.ForeColor = Color.FromArgb(220, 220, 220);
            btnThrowGrenade.Location = new Point(130, 192);
            btnThrowGrenade.Name = "btnThrowGrenade";
            btnThrowGrenade.Size = new Size(115, 28);
            btnThrowGrenade.TabIndex = 9;
            btnThrowGrenade.Text = "Grenade";
            btnThrowGrenade.UseVisualStyleBackColor = false;
            btnThrowGrenade.Click += btnThrowGrenade_Click;
            // 
            // grpKillstreaks
            // 
            grpKillstreaks.Controls.Add(lblKillstreak);
            grpKillstreaks.Controls.Add(cmbKillstreak);
            grpKillstreaks.Controls.Add(chkSameTeam);
            grpKillstreaks.Controls.Add(btnActivateKillstreak);
            grpKillstreaks.Controls.Add(btnNuke);
            grpKillstreaks.ForeColor = Color.FromArgb(180, 180, 180);
            grpKillstreaks.Location = new Point(1298, 9);
            grpKillstreaks.Name = "grpKillstreaks";
            grpKillstreaks.Size = new Size(260, 182);
            grpKillstreaks.TabIndex = 13;
            grpKillstreaks.TabStop = false;
            grpKillstreaks.Text = "Killstreaks";
            // 
            // lblKillstreak
            // 
            lblKillstreak.AutoSize = true;
            lblKillstreak.Location = new Point(15, 25);
            lblKillstreak.Name = "lblKillstreak";
            lblKillstreak.Size = new Size(57, 15);
            lblKillstreak.TabIndex = 0;
            lblKillstreak.Text = "Killstreak:";
            // 
            // cmbKillstreak
            // 
            cmbKillstreak.BackColor = Color.FromArgb(40, 40, 43);
            cmbKillstreak.FlatStyle = FlatStyle.Flat;
            cmbKillstreak.ForeColor = Color.FromArgb(220, 220, 220);
            cmbKillstreak.Items.AddRange(new object[] { "UAV", "Super Soldier", "Counter UAV", "Advanced UAV", "Haste", "Nuke" });
            cmbKillstreak.Location = new Point(15, 43);
            cmbKillstreak.Name = "cmbKillstreak";
            cmbKillstreak.Size = new Size(230, 23);
            cmbKillstreak.TabIndex = 1;
            // 
            // chkSameTeam
            // 
            chkSameTeam.AutoSize = true;
            chkSameTeam.Location = new Point(15, 75);
            chkSameTeam.Name = "chkSameTeam";
            chkSameTeam.Size = new Size(115, 19);
            chkSameTeam.TabIndex = 2;
            chkSameTeam.Text = "Same Team Only";
            // 
            // btnActivateKillstreak
            // 
            btnActivateKillstreak.BackColor = Color.FromArgb(255, 140, 0);
            btnActivateKillstreak.FlatStyle = FlatStyle.Flat;
            btnActivateKillstreak.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            btnActivateKillstreak.ForeColor = Color.White;
            btnActivateKillstreak.Location = new Point(15, 100);
            btnActivateKillstreak.Name = "btnActivateKillstreak";
            btnActivateKillstreak.Size = new Size(230, 28);
            btnActivateKillstreak.TabIndex = 3;
            btnActivateKillstreak.Text = "Activate Killstreak";
            btnActivateKillstreak.UseVisualStyleBackColor = false;
            btnActivateKillstreak.Click += btnActivateKillstreak_Click;
            // 
            // btnNuke
            // 
            btnNuke.BackColor = Color.FromArgb(200, 0, 0);
            btnNuke.FlatStyle = FlatStyle.Flat;
            btnNuke.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            btnNuke.ForeColor = Color.White;
            btnNuke.Location = new Point(15, 133);
            btnNuke.Name = "btnNuke";
            btnNuke.Size = new Size(230, 28);
            btnNuke.TabIndex = 4;
            btnNuke.Text = "🔥 NUKE 🔥";
            btnNuke.UseVisualStyleBackColor = false;
            btnNuke.Click += btnNuke_Click;
            // 
            // grpGameControl
            // 
            grpGameControl.Controls.Add(btnFlash);
            grpGameControl.Controls.Add(btnTeleport);
            grpGameControl.Controls.Add(lblTimeScale);
            grpGameControl.Controls.Add(nudTimeScale);
            grpGameControl.Controls.Add(btnSetTimeScale);
            grpGameControl.Controls.Add(chkMatchOver);
            grpGameControl.Controls.Add(btnMatchOver);
            grpGameControl.ForeColor = Color.FromArgb(180, 180, 180);
            grpGameControl.Location = new Point(1298, 194);
            grpGameControl.Name = "grpGameControl";
            grpGameControl.Size = new Size(260, 170);
            grpGameControl.TabIndex = 14;
            grpGameControl.TabStop = false;
            grpGameControl.Text = "Game Control";
            // 
            // btnFlash
            // 
            btnFlash.BackColor = Color.FromArgb(60, 60, 63);
            btnFlash.FlatStyle = FlatStyle.Flat;
            btnFlash.ForeColor = Color.FromArgb(220, 220, 220);
            btnFlash.Location = new Point(15, 25);
            btnFlash.Name = "btnFlash";
            btnFlash.Size = new Size(109, 28);
            btnFlash.TabIndex = 0;
            btnFlash.Text = "Flash Effect";
            btnFlash.UseVisualStyleBackColor = false;
            btnFlash.Click += btnFlash_Click;
            // 
            // btnTeleport
            // 
            btnTeleport.BackColor = Color.FromArgb(60, 60, 63);
            btnTeleport.FlatStyle = FlatStyle.Flat;
            btnTeleport.ForeColor = Color.FromArgb(220, 220, 220);
            btnTeleport.Location = new Point(130, 25);
            btnTeleport.Name = "btnTeleport";
            btnTeleport.Size = new Size(115, 28);
            btnTeleport.TabIndex = 1;
            btnTeleport.Text = "Teleport";
            btnTeleport.UseVisualStyleBackColor = false;
            btnTeleport.Click += btnTeleport_Click;
            // 
            // lblTimeScale
            // 
            lblTimeScale.AutoSize = true;
            lblTimeScale.Location = new Point(15, 60);
            lblTimeScale.Name = "lblTimeScale";
            lblTimeScale.Size = new Size(67, 15);
            lblTimeScale.TabIndex = 2;
            lblTimeScale.Text = "Time Scale:";
            // 
            // nudTimeScale
            // 
            nudTimeScale.BackColor = Color.FromArgb(40, 40, 43);
            nudTimeScale.BorderStyle = BorderStyle.FixedSingle;
            nudTimeScale.DecimalPlaces = 2;
            nudTimeScale.ForeColor = Color.FromArgb(220, 220, 220);
            nudTimeScale.Increment = new decimal(new int[] { 25, 0, 0, 131072 });
            nudTimeScale.Location = new Point(15, 78);
            nudTimeScale.Maximum = new decimal(new int[] { 5, 0, 0, 0 });
            nudTimeScale.Minimum = new decimal(new int[] { 1, 0, 0, 65536 });
            nudTimeScale.Name = "nudTimeScale";
            nudTimeScale.Size = new Size(110, 23);
            nudTimeScale.TabIndex = 3;
            nudTimeScale.Value = new decimal(new int[] { 1, 0, 0, 0 });
            // 
            // btnSetTimeScale
            // 
            btnSetTimeScale.BackColor = Color.FromArgb(60, 60, 63);
            btnSetTimeScale.FlatStyle = FlatStyle.Flat;
            btnSetTimeScale.ForeColor = Color.FromArgb(220, 220, 220);
            btnSetTimeScale.Location = new Point(130, 78);
            btnSetTimeScale.Name = "btnSetTimeScale";
            btnSetTimeScale.Size = new Size(115, 23);
            btnSetTimeScale.TabIndex = 4;
            btnSetTimeScale.Text = "Set";
            btnSetTimeScale.UseVisualStyleBackColor = false;
            btnSetTimeScale.Click += btnSetTimeScale_Click;
            // 
            // chkMatchOver
            // 
            chkMatchOver.AutoSize = true;
            chkMatchOver.Location = new Point(15, 110);
            chkMatchOver.Name = "chkMatchOver";
            chkMatchOver.Size = new Size(88, 19);
            chkMatchOver.TabIndex = 5;
            chkMatchOver.Text = "Match Over";
            // 
            // btnMatchOver
            // 
            btnMatchOver.BackColor = Color.FromArgb(255, 68, 68);
            btnMatchOver.FlatStyle = FlatStyle.Flat;
            btnMatchOver.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            btnMatchOver.ForeColor = Color.White;
            btnMatchOver.Location = new Point(15, 133);
            btnMatchOver.Name = "btnMatchOver";
            btnMatchOver.Size = new Size(230, 28);
            btnMatchOver.TabIndex = 6;
            btnMatchOver.Text = "Toggle Match Over";
            btnMatchOver.UseVisualStyleBackColor = false;
            btnMatchOver.Click += btnMatchOver_Click;
            // 
            // nudColorR
            // 
            nudColorR.BackColor = Color.FromArgb(40, 40, 43);
            nudColorR.BorderStyle = BorderStyle.FixedSingle;
            nudColorR.ForeColor = Color.FromArgb(220, 220, 220);
            nudColorR.Location = new Point(85, 98);
            nudColorR.Maximum = new decimal(new int[] { 255, 0, 0, 0 });
            nudColorR.Name = "nudColorR";
            nudColorR.Size = new Size(50, 23);
            nudColorR.TabIndex = 3;
            nudColorR.Value = new decimal(new int[] { 255, 0, 0, 0 });
            // 
            // nudColorG
            // 
            nudColorG.BackColor = Color.FromArgb(40, 40, 43);
            nudColorG.BorderStyle = BorderStyle.FixedSingle;
            nudColorG.ForeColor = Color.FromArgb(220, 220, 220);
            nudColorG.Location = new Point(140, 98);
            nudColorG.Maximum = new decimal(new int[] { 255, 0, 0, 0 });
            nudColorG.Name = "nudColorG";
            nudColorG.Size = new Size(50, 23);
            nudColorG.TabIndex = 4;
            nudColorG.Value = new decimal(new int[] { 255, 0, 0, 0 });
            // 
            // nudColorB
            // 
            nudColorB.BackColor = Color.FromArgb(40, 40, 43);
            nudColorB.BorderStyle = BorderStyle.FixedSingle;
            nudColorB.ForeColor = Color.FromArgb(220, 220, 220);
            nudColorB.Location = new Point(196, 98);
            nudColorB.Maximum = new decimal(new int[] { 255, 0, 0, 0 });
            nudColorB.Name = "nudColorB";
            nudColorB.Size = new Size(50, 23);
            nudColorB.TabIndex = 5;
            nudColorB.Value = new decimal(new int[] { 255, 0, 0, 0 });
            // 
            // grpChat
            // 
            grpChat.Controls.Add(lblChatMsg);
            grpChat.Controls.Add(txtChatMessage);
            grpChat.Controls.Add(lblChatColor);
            grpChat.Controls.Add(nudColorR);
            grpChat.Controls.Add(nudColorG);
            grpChat.Controls.Add(nudColorB);
            grpChat.Controls.Add(btnSendChat);
            grpChat.ForeColor = Color.FromArgb(180, 180, 180);
            grpChat.Location = new Point(1298, 366);
            grpChat.Name = "grpChat";
            grpChat.Size = new Size(261, 180);
            grpChat.TabIndex = 15;
            ...
            // lblChatMsg
            // 
            lblChatMsg.AutoSize = true;
            lblChatMsg.Location = new Point(15, 25);
            lblChatMsg.Name = "lblChatMsg";
            lblChatMsg.Size = new Size(56, 15);
            lblChatMsg.TabIndex = 0;
            lblChatMsg.Text = "Message:";
            // 
            // txtChatMessage
            // 
            txtChatMessage.BackColor = Color.FromArgb(40, 40, 43);
            txtChatMessage.BorderStyle = BorderStyle.FixedSingle;
            txtChatMessage.ForeColor = Color.FromArgb(220, 220, 220);
            txtChatMessage.Location = new Point(15, 43);
            txtChatMessage.Multiline = true;
            txtChatMessage.Name = "txtChatMessage";
            txtChatMessage.PlaceholderText = "Enter chat message...";
            txtChatMessage.Size = new Size(231, 50);
            txtChatMessage.TabIndex = 1;
            // 
            // lblChatColor
            // 
            lblChatColor.AutoSize = true;
            lblChatColor.Location = new Point(15, 100);
            lblChatColor.Name = "lblChatColor";
            lblChatColor.Size = new Size(64, 15);
            lblChatColor.TabIndex = 2;
            lblChatColor.Text = "RGB Color:";
            // 
            // btnSendChat
            // 
            btnSendChat.BackColor = Color.FromArgb(255, 68, 68);
            ...
            btnSendChat.Location = new Point(15, 130);
            btnSendChat.Name = "btnSendChat";
            btnSendChat.Size = new Size(230, 28);
            btnSendChat.TabIndex = 6;
            ...
            grpEvents.Location = new Point(13, 546);
            ...
            grpConsole.Location = new Point(559, 546);
            ...
            ClientSize = new Size(1584, 793);
            Controls.Add(grpCombat);
            Controls.Add(grpKillstreaks);
            ...
            grpKillstreaks.ResumeLayout(false);
            grpKillstreaks.PerformLayout();
            grpGameControl.ResumeLayout(false);
            grpGameControl.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)nudTimeScale).EndInit();
            ((System.ComponentModel.ISupportInitialize)nudColorR).EndInit();
            ((System.ComponentModel.ISupportInitialize)nudColorG).EndInit();
            ((System.ComponentModel.ISupportInitialize)nudColorB).EndInit();
        ...
        private ComboBox cmbTargetPlayer;
        private Label lblDamageAmount;
        private NumericUpDown nudDamage;
        private CheckBox chkHeadshot;
        private Button btnDamagePlayer;
        private Button btnShowHitmarker;
        private Button btnMeleeAttack;
        private Button btnReload;
        private Button btnThrowGrenade;

        private GroupBox grpKillstreaks;
        private Label lblKillstreak;
        private ComboBox cmbKillstreak;
        private CheckBox chkSameTeam;
        private Button btnActivateKillstreak;
        private Button btnNuke;

        private GroupBox grpGameControl;
        private Button btnFlash;
        private Button btnTeleport;
        private Label lblTimeScale;
        private NumericUpDown nudTimeScale;
        private Button btnSetTimeScale;
        private CheckBox chkMatchOver;
        private Button btnMatchOver;

        private GroupBox grpChat;
        private Label lblChatMsg;
        private TextBox txtChatMessage;
        private Label lblChatColor;
        private NumericUpDown nudColorR;
        private NumericUpDown nudColorG;
        private NumericUpDown nudColorB;
